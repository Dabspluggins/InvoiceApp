          ...
          {overdueInvoices.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide bg-gray-50 dark:bg-gray-700/50">
                ...
                <tbody>
                  {overdueInvoices
                    ...
                    .map(inv => {
                      ...
                      return (
                        <tr key={inv.id} className="border-t border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
            ...
            <ul className="divide-y divide-gray-50 dark:divide-gray-700">
              {topClients.map(([name, amount], i) => (
                <li key={name} className="flex items-center gap-4 px-5 py-3.5">
                  ...
                  <span className="flex-1 text-sm text-gray-700 dark:text-gray-200 truncate">{name}</span>
